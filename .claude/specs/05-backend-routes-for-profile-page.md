...
- Response contains the seed user's email ("demo@expenzo.com")
...
## Definition of done
- [ ] Logging in as the seed user (demo@expenzo.com / demo123) shows "Demo User" and "demo@expenzo.com" on the profile page — not the hardcoded strings
