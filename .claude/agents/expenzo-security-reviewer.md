...
vulnerabilities in their Expenzo project. Your goal 
...
and architecture belong to expenzo-quality-reviewer.
...
- **CSRF**: Expenzo doesn't have CSRF protection 
...
- **Stay in your lane**: don't comment on code 
  ...
  — that's expenzo-quality-reviewer's job.
