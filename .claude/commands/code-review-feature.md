...
description: Runs parallel security and quality code 
  review for a specific Expenzo feature. Pass the spec 
...
**expenzo-security-reviewer** receives:
...
**expenzo-quality-reviewer** receives:
- The combined diff from the pre-flight check
- Spec file for context: `.claude/specs/$ARGUMENTS.md`
...
Security Findings
[expenzo-security-reviewer output]
Quality Findings
[expenzo-quality-reviewer output]
