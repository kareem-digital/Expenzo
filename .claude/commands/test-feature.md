---
description: Writes and runs tests for a specific Expenzo feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **expenzo-test-writer** subagent with the 
following context:
...
Wait for expenzo-test-writer to fully complete and 
...
Once expenzo-test-writer has finished, invoke the 
**expenzo-test-runner** subagent with the following 
context:
...
- If expenzo-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the expenzo-test-runner's structured report
